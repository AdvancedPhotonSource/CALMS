...
def lint_cmd(py_str: str, lint_fp, py_pfx = None):
    """
...
def polybot_linter(py_str: str):
    ...
    lint_fp = POLYBOT_RUN_FILE_PATH
    lint_output = lint_cmd(py_str, lint_fp, py_pfx=POLYBOT_RUN_FILE)
...
exec_polybot_lint_tool = StructuredTool.from_function(
    ...
    + " Always run the linter to check any codes."
